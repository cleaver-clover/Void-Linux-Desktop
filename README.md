...
(usefull)
# xbps-install htop timeshift keepassxc engrampa syncthing gparted gammastep  elogind polkit-gnome baobab 
(development)
...
```
# xbps-install mesa-dri-32bit mesa-vulkan-radeon-32bit
```
